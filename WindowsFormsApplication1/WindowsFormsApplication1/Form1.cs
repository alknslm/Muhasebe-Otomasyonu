...
namespace WindowsFormsApplication1
{
...

    {
        ...
        {   
            ...
            lblFiyatı.Text = ((float)urun.fiyat * int.Parse(txtAdet.Text)).ToString();
        ...
        private void btnUrünEkle_Click(object sender, EventArgs e)
        {
            ...
            if (txtAdet.Text == "" || Convert.ToInt32(txtAdet.Text) == 0 || txtMusteriAd.Text == "" || txtMusteriSoyad.Text == "" || txtMusteriTel.Text == "" || Convert.ToInt32(txtMusteriTel.Text) == 0)
            {
                MessageBox.Show("Lütfen istenilen bilgileri eksiksi doldurunuz");
            }
            else
            {
